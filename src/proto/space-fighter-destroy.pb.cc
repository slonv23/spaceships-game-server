...
// source: space-fighter-destroy.proto
...
namespace protobuf_space_2dfighter_2ddestroy_2eproto {
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "space-fighter-destroy.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\033space-fighter-destroy.proto\022\013multiplay"
      "er\"\025\n\023SpaceFighterDestroyb\006proto3"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 73);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "space-fighter-destroy.proto", &protobuf_RegisterTypes);
}
...
SpaceFighterDestroy::SpaceFighterDestroy()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_space_2dfighter_2ddestroy_2eproto::scc_info_SpaceFighterDestroy.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* SpaceFighterDestroy::descriptor() {
  ::protobuf_space_2dfighter_2ddestroy_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_space_2dfighter_2ddestroy_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const SpaceFighterDestroy& SpaceFighterDestroy::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_space_2dfighter_2ddestroy_2eproto::scc_info_SpaceFighterDestroy.base);
...
::google::protobuf::Metadata SpaceFighterDestroy::GetMetadata() const {
  protobuf_space_2dfighter_2ddestroy_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_space_2dfighter_2ddestroy_2eproto::file_level_metadata[kIndexInFileMessages];
}
